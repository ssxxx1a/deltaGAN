...
class TrainOptions:
    ...
    def initialize(self):
        ...
        # loss lambdas
        self.parser.add_argument('--lpips_lambda', default=0.8, type=float,
        ...
        # hypernet parameters
        self.parser.add_argument('--load_w_encoder', type=bool,default=True, help='Whether to load the w e4e encoder.')
        ...
        self.parser.add_argument('--w_encoder_type', default='SharedWeightsHyperNetResNet',
        ...
        # aus setting
        self.parser.add_argument('--root_path', default='/raid/hzhang/AffectNet/', type=str)
        self.parser.add_argument('--data_train', default='best_data.pkl', type=str, help='???')
        self.parser.add_argument('--data_test', default='best_data_val.pkl', type=str, help='???')
